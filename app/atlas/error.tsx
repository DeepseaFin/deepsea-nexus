  ...
  return (
    <div className="min-h-[60vh] p-6 sm:p-8">
      <div className="mx-auto max-w-3xl rounded-xl border border-rose-800/50 bg-rose-950/20 p-6">
        <p className="text-xs uppercase tracking-[0.14em] text-rose-300">Workspace Error</p>
        <h2 className="mt-2 text-xl font-semibold text-rose-100">Unable to render this workspace</h2>
        <p className="mt-2 text-sm text-rose-200/90">
          {error.message || "An unexpected issue occurred while loading workspace data."}
        </p>
        <button
          type="button"
          onClick={reset}
