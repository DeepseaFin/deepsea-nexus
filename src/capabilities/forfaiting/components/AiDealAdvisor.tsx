import type { AiDealAdvisorState } from "@/src/capabilities/forfaiting/types/ForfaittingWorkspaceState";

type AiDealAdvisorProps = {
  readonly advisor: AiDealAdvisorState;
};

export default function AiDealAdvisor({ advisor }: AiDealAdvisorProps) {
  return (
    <aside className="rounded-lg border border-slate-800 bg-slate-900/40 p-4">
      <h2 className="text-lg font-semibold text-slate-100">AI Deal Advisor</h2>
