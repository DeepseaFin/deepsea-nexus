import type { TreasuryTimelineItem } from "@/src/capabilities/treasury/types/TreasuryWorkspaceState";

type TreasuryTimelineProps = {
  readonly timeline: readonly TreasuryTimelineItem[];
};

export default function TreasuryTimeline({ timeline }: TreasuryTimelineProps) {
  return (
    <section className="rounded-lg border border-slate-800 bg-slate-900/40 p-4">
      <h2 className="text-lg font-semibold text-slate-100">Treasury Timeline</h2>
