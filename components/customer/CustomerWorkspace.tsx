...
export default function CustomerWorkspace({
  ...
  const registryModels: CustomerWorkspaceRegistryModels = useMemo(() => {
    return {
      ...
      businessPassportViewModel: businessPassportViewModel ?? undefined,
      documentsPanelModel: resolvedDocumentsPanelModel,
      documentsViewModel: documentsViewModel ?? undefined,
      relationshipPanelModel: resolvedRelationshipPanelModel,
      relationshipViewModel: relationshipViewModel ?? undefined,
      approvalPanelModel: resolvedApprovalPanelModel,
      approvalViewModel: approvalViewModel ?? undefined,
      fundingViewModel: fundingViewModel ?? undefined,
      aiInsightsViewModel: aiInsightsViewModel ?? undefined,
      institutionalTimelineViewModel: institutionalTimelineViewModel ?? undefined,
      workflowViewModel: workflowViewModel ?? undefined,
