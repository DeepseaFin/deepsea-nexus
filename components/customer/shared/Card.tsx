...
export default function Card({
  ...
  return (
    <section
      ...
      className={`rounded-2xl border border-slate-800/90 bg-[linear-gradient(180deg,rgba(15,23,42,0.78),rgba(2,6,23,0.92))] shadow-[0_14px_32px_rgba(2,6,23,0.28)] backdrop-blur-sm transition-colors hover:border-slate-700 focus-within:border-cyan-500/50 focus-within:ring-2 focus-within:ring-cyan-400/40 ${className}`}
    >
