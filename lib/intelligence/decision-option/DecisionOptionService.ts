...
export interface DecisionOptionService {
  create(input: CreateDecisionOptionInput): Promise<DecisionOption>;
  get(decisionOptionId: DecisionOptionId): Promise<DecisionOption | null>;
