...
function toFinancialProfile(input: BusinessPassportCompletionEngineInput): FinancialProfile {
  ...
  return {
    ...
    evidence: [],
    estimatedRevenue: documentCoverage > 0 ? { amount: 120_000_000, currency: "AED" } : undefined,
    verifiedRevenue: evidenceCoverage > 1 ? { amount: 110_000_000, currency: "AED" } : undefined,
    workingCapital: documentCoverage > 1 ? { amount: 34_000_000, currency: "AED" } : undefined,
    receivables: evidenceCoverage > 0 ? { amount: 24_000_000, currency: "AED" } : undefined,
    payables: undefined,
