...
Store historical memory that provides continuity across teams, leadership, and time.

## Scope

This section contains official records and reference documents that belong strictly to the Institutional-Memory domain within the Deepsea Legacy Repository.
...
Primary ownership: Assigned custodian for Institutional-Memory.
